 ...
 */
public class DBDriveFileHelper {



    private static DBDriveFileHelper sDBDriveFileHelper;
    private final Context mContext;
    private static final String TABLE_NAME = "DBDriveFile";
    ...
    public DBDriveFileHelper(Context context){
        mContext = context.getApplicationContext();
    }

    public static DBDriveFileHelper getInstance(Context context) {
        if(sDBDriveFileHelper==null)
            sDBDriveFileHelper = new DBDriveFileHelper(context);
